...
export type ReportType = "pl" | "channels" | "stock";
...
export function ReportView({ reportType }: { reportType: ReportType }) {
  ...
  return (
    <div className="flex w-full flex-col">
      <PageToolbar icon={pageIcon} title={pageTitle} />
